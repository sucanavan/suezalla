...
### Modifying gridlines and backgrounds

To add, remove, or restyle gridlines and backgrounds, use `theme()` layering:
...
```r
theme_minimal() + theme(panel.grid = element_blank(), panel.background = element_blank())
```
