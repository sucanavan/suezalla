...
- Several curated colour palettes inspired by polaroids, jam jars, retro aesthetics, and corporate tones
- Custom scale functions: `scale_colour_suezalla()` and `scale_fill_suezalla()`

These tools help you create clean, consistent visualizations with minimal effort.
...
This example shows how to apply a custom palette and theme to a scatter plot using `ggplot2`.
