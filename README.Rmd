...
The `suezalla` package automatically loads the Roboto and XKCD fonts (if available) using the `sysfonts` and `showtext` packages. No manual steps are needed.

- Roboto is loaded from Google Fonts.
- XKCD is loaded if you have installed `xkcd.ttf` in your system fonts folder or working directory.
